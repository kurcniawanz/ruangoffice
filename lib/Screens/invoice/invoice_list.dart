...
class _KerjaListState extends State<KerjaList> with TickerProviderStateMixin {
  List listdata = [];
  String ketdata = '';
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => KerjaDetails(noinv: result['noinv'])));
            },
          );
        });
  }
